...
class Solution {
    fun superPow(a: Int, b: IntArray): Int {
        ...
        var result = 1
        var a = a % mod
        (b.lastIndex downTo 0).forEach { i ->
    ...
    private fun pow(a: Int, b: Int, mod: Int = 1337): Int {
        var a = a % mod
        var b = b
        var ans = 1
        while (b != 0) {
            if (b and 1 == 1) ans = (ans * a) % mod
            a = (a * a) % mod
            b = b shr 1
        }
        return ans
